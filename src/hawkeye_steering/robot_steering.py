...
class HawkeyeSteering(Plugin):
    ...
    def _on_x_linear_slider_changed(self):
        self._widget.current_x_linear_label.setText(
            '%0.2f m/s' % (self._widget.x_linear_slider.value() / HawkeyeSteering.slider_factor))
        self._on_parameter_changed()

    def _on_z_angular_slider_changed(self):
        self._widget.current_z_angular_label.setText(
            '%0.2f rad/s' % (self._widget.z_angular_slider.value() / HawkeyeSteering.slider_factor))
        self._on_parameter_changed()
    ...
    def _on_max_x_linear_changed(self, value):
        self._widget.x_linear_slider.setMaximum(
            value * HawkeyeSteering.slider_factor)
    ...
    def _on_parameter_changed(self):
        self._send_twist(
            self._widget.x_linear_slider.value() / HawkeyeSteering.slider_factor,
            self._widget.z_angular_slider.value() / HawkeyeSteering.slider_factor)
