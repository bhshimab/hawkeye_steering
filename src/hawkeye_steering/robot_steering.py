...
class HawkeyeSteering(Plugin):
	...
	# Define WASD keybinds and behavior
	...
	self.shortcut_w.activated.connect(self.button_pressed)
	...
	self.shortcut_s.activated.connect(self.button_pressed)
	...
	self.shortcut_a.activated.connect(self.button_pressed)
	...
	self.shortcut_d.activated.connect(self.button_pressed)

	# Auto timeout and zero pulse sent
	self.flag = 0
        self.zero_cmd_sent = False
        self.timer = QTimer(self)
        self.timer.timeout.connect(self._send_zero)
        self.timer.start(50)
	...
	# Display the set speed next to the speed sliders
